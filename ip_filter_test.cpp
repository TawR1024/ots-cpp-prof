...
{
   public:
    std::vector<std::string> input{"10.20.30.40", "1.1.1.1", "8.8.8.8", "192.168.1.1", "192.168.1.1", "234.666.999.1"};
};
...
TEST_F (IPFilter, convertStringToIPv4)
{
    ...
    EXPECT_THROW (IPv4Address (this->input.at (5)), std::out_of_range);
}
